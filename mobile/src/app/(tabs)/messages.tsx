...
export default function MessagesScreen() {
  ...
  const load = useCallback(async () => { if (!getCachedApiData(MESSAGES_PATH)) setLoading(true); setError(''); try { setThreads(await apiCached<Thread[]>(MESSAGES_PATH)); } catch (e) { setError(e instanceof Error ? e.message : 'Could not load messages.'); } finally { setLoading(false); } }, []);
