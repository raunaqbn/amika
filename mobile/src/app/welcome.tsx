...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.paper }, scroll: { minHeight: '100%', padding: 22, justifyContent: 'center', gap: 26 }, brand: { alignItems: 'center' }, mark: { width: 72, height: 72, borderRadius: 24, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.periwinkle, ...border, ...shadow }, sparkle: { position: 'absolute', top: 8, right: 8 }, logo: { fontFamily: type.heavy, fontSize: 44, letterSpacing: -2, color: colors.ink, marginTop: 17 }, tagline: { fontFamily: type.medium, color: colors.muted, fontSize: 16, lineHeight: 23, textAlign: 'center', marginTop: 5, maxWidth: 320 }, packet: { backgroundColor: colors.periwinkle, borderRadius: 22, padding: 17, gap: 15, ...border, ...shadow }, tabs: { flexDirection: 'row', backgroundColor: 'rgba(255,255,255,.35)', borderRadius: 15 }, googleButton: { minHeight: 52, paddingHorizontal: 16, borderRadius: 14, backgroundColor: colors.white, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10, ...border }, googlePressed: { transform: [{ translateY: 2 }] }, googleMark: { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.paper, alignItems: 'center', justifyContent: 'center', ...border }, googleLetter: { fontFamily: type.heavy, fontSize: 16, color: '#3158A6' }, googleText: { fontFamily: type.heavy, fontSize: 15, color: colors.ink }, disabled: { opacity: .5 }, foot: { fontFamily: type.medium, fontSize: 12, lineHeight: 18, textAlign: 'center', color: colors.muted, paddingHorizontal: 20 },
});
