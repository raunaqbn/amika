...
const styles = StyleSheet.create({
  ...
  content: { width: '100%', maxWidth: 620, alignSelf: 'center', padding: 18, paddingBottom: 32, gap: 20 },
  intro: { padding: 20, borderRadius: 20, backgroundColor: colors.sky, ...border, ...shadow },
  introIcon: { width: 48, height: 48, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: colors.citrus, ...border },
  title: { maxWidth: 330, marginTop: 18, fontFamily: type.heavy, color: colors.ink, fontSize: 27, lineHeight: 31 },
  body: { maxWidth: 430, marginTop: 7, fontFamily: type.regular, color: colors.ink, fontSize: 14, lineHeight: 20 },
  count: { marginTop: 16, fontFamily: type.heavy, color: colors.periwinkleDark, fontSize: 11, textTransform: 'uppercase', letterSpacing: .9 },
  selection: { gap: 13, padding: 17, borderRadius: 18, backgroundColor: colors.white, ...border },
