...
const styles = StyleSheet.create({
  ...
  interestsRow: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 11, paddingVertical: 9, borderRadius: 15, backgroundColor: colors.white, ...border },
  interestsIcon: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: colors.sky, ...border },
  interestsCopy: { minWidth: 0, flex: 1 },
  interestsTitle: { fontFamily: type.heavy, color: colors.ink, fontSize: 14 },
  interestsSummary: { marginTop: 2, fontFamily: type.regular, color: colors.muted, fontSize: 11 },
  interestsCount: { minWidth: 24, height: 24, textAlign: 'center', lineHeight: 23, overflow: 'hidden', borderRadius: 12, backgroundColor: colors.citrus, fontFamily: type.heavy, color: colors.ink, fontSize: 10, ...border },
