...
export default function PublicWishlistPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#A8C5A8]/10 to-white flex items-center justify-center pt-14 md:pt-16 pb-20 md:pb-0">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#A8C5A8]/10 to-white pt-14 md:pt-16 pb-20 md:pb-0">
