...
// GET /api/trips/[id]/polls - List polls
export async function GET(
  ...
  try {
    ...
    const polls = await prisma.tripPoll.findMany(id, userId, context);
...
export async function POST(
  ...
  try {
    ...
    const poll = await prisma.tripPoll.create(id, {
      context,
      question,
      options,
    }, userId);
...
// PUT /api/trips/[id]/polls - Close poll
export async function PUT(
  ...
  try {
    ...
    const poll = await prisma.tripPoll.close(pollId, userId);
