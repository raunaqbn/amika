...
export function useTripSync(
  ...
  }, [enabled, tripId, effectiveInterval, sync, isVisible]);
  ...
  }, [enabled, tripId, effectivePresenceInterval, fetchTypingUsers, fetchActiveUsers, sendPresenceHeartbeat, isVisible]);
