...
export function ShareTripDialog({
  ...
  const generateInviteLink = async () => {
    ...
    setError(null);
    try {
      console.log('Generating invite link for trip:', tripId);
  ...
  const getInviteUrl = () => {
    ...
    return `${baseUrl}/trips/join/${joinToken}`;
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] bg-white max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Invite friends to collaborate on &quot;{tripTitle}&quot;
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-4 border-t">
            ...
            <p className="text-xs text-muted-foreground">
              Anyone with this link can sign in and join the trip
            </p>
          ...
          {existingCollaborators.length > 0 && (
            <div className="space-y-3 pt-4 border-t">
              <label className="text-sm font-medium">Current Collaborators ({existingCollaborators.length})</label>
