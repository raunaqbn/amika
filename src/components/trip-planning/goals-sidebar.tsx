...
import { Check, Circle, Clock, Calendar, MapPin, CalendarDays, Ticket, Users } from 'lucide-react';
...
const goalConfig: Record<string, { icon: any; label: string }> = {
  dates: { icon: Calendar, label: 'Trip Dates' },
  location: { icon: MapPin, label: 'Location' },
  daily_events: { icon: CalendarDays, label: 'Daily Events' },
...
export function GoalsSidebar({
  ...
  const progressPercent = (completedCount / goalProgress.length) * 100;
